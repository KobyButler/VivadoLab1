...
HD_PWD='C:/Users/Koby Butler/Desktop/Lab1/Lab1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log InstructionFetchUnit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source InstructionFetchUnit.tcl -notrace
